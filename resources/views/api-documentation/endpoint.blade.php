...
<body>
  <nav class="{{ config('sidebar-menu')['colors']['secondary-name'] }}">
      ...
      <div class="card margin-top big">
        <div class="card-content">
          <div class="margin-top big">
            ...
            @else
              <h6 class="text-centered">No Headers</h6>
            @endif
          </div>
          <div class="margin-top big">
                ...
                <tbody>
                  @foreach ($parameters as $parameter)
                    <tr>
                      ...
                      <td>
                        @foreach (explode("[#]", $parameter["validation"]) as $rule)
            ...
            @else
              <h6 class="text-centered">No Parameters</h6>
            @endif
          </div>
        </div>
      </div>
      ...
      <div class="card margin-top big">
        <div class="card-content">
          @foreach ($endpoint["responses"]() as $response)
            ...
            <h5 class="text-centered">Raw JSON</h5>
            <pre>
